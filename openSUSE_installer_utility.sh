...
zypper --no-gpg-checks  ar  http://download.opensuse.org/repositories/multimedia:/libs/openSUSE_13.1/ "multmedia" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionado repositório Multimídia" --progress --pulsate
...
zypper --no-gpg-checks  ar  http://download.opensuse.org/repositories/multimedia:/apps/openSUSE_13.1/ "av" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionado repositório Áudio e Video" --progress --pulsate --percentage="50"

zypper --no-gpg-checks  ar  http://download.opensuse.org/repositories/KDE:/Extra/openSUSE_13.1/ "Extras" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionando repositorio Extras" --progress --pulsate
...
zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/openSUSE:/13.1/standard/ "skype" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionando repositorio Network Extra" --progress --pulsate


zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/home:/lijews:/branches:/OBS_Maintained:/opera/openSUSE_12.3_NonFree_Update/ "nonfree1" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionando repositorio NonFree" --progress --pulsate
...
zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/home:/Simmphonie/openSUSE_13.1/ "av2" | zenity --title="Adicionado repositórios" --width="500" --height="200" --text="Adicionando repositorio Multimídia Extra" --progress --pulsate

zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/GNOME:/Apps/openSUSE_13.1/ "grafico" | zenity --title="Adicionado repositórios" --width="500" --height="100" --text="Adicionando repositorio Graficos Extra" --progress --pulsate

zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/GNOME:/Apps/openSUSE_13.1/ "pidgin" | zenity --title="Adicionado repositórios" --width="500" --height="100" --text="Adicionando repositorio Extra" --progress --pulsate

zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/network:/chromium/openSUSE_13.1/ "net2" | zenity --title="Adicionado repositórios" --width="500" --height="100" --text="Adicionando repositorio Extra" --progress --pulsate

zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/home:/RedDwarf/openSUSE_13.1/ "auda" | zenity --title="Adicionado repositórios" --width="500" --height="100" --text="Adicionando repositorio Extra" --progress --pulsate

zypper --no-gpg-checks  ar http://download.opensuse.org/repositories/utilities/openSUSE_13.1/ "utilidades" | zenity --title="Adicionado repositórios" --width="500" --height="100" --text="Adicionando repositorio Extra" --progress --pulsate
